...
#define CPUFREQ_PREFS(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), CPUFREQ_TYPE_PREFS, CPUFreqPrefs))
#define CPUFREQ_PREFS_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass), CPUFREQ_TYPE_PREFS, CPUFreqPrefsClass))
#define CPUFREQ_IS_PREFS(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), CPUFREQ_TYPE_PREFS))
#define CPUFREQ_IS_PREFS_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), CPUFREQ_TYPE_PREFS))
#define CPUFREQ_PREFS_GET_CLASS(obj) \
  (G_TYPE_INSTANCE_GET_CLASS((obj), CPUFREQ_TYPE_PREFS, CPUFreqPrefsClass))
