...
#define CPUFREQ_SELECTOR(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), CPUFREQ_TYPE_SELECTOR, CPUFreqSelector))
#define CPUFREQ_SELECTOR_CLASS(klass)                      \
  (G_TYPE_CHECK_CLASS_CAST((klass), CPUFREQ_TYPE_SELECTOR, \
                           CPUFreqSelectorClass))
#define CPUFREQ_IS_SELECTOR(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), CPUFREQ_TYPE_SELECTOR))
#define CPUFREQ_IS_SELECTOR_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), CPUFREQ_TYPE_SELECTOR))
#define CPUFREQ_SELECTOR_GET_CLASS(obj)                    \
  (G_TYPE_INSTANCE_GET_CLASS((obj), CPUFREQ_TYPE_SELECTOR, \
                             CPUFreqSelectorClass))
...
struct _CPUFreqSelectorClass {
  ...
  gboolean (*set_frequency)(CPUFreqSelector *selector, guint frequency,
                            GError **error);
  gboolean (*set_governor)(CPUFreqSelector *selector, const gchar *governor,
                           GError **error);
};
