...
#define CPUFREQ_SELECTOR_LIBCPUFREQ(obj)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), CPUFREQ_TYPE_SELECTOR_LIBCPUFREQ, \
                              CPUFreqSelectorLibcpufreq))
#define CPUFREQ_SELECTOR_LIBCPUFREQ_CLASS(klass)                      \
  (G_TYPE_CHECK_CLASS_CAST((klass), CPUFREQ_TYPE_SELECTOR_LIBCPUFREQ, \
                           CPUFreqSelectorLibcpufreqClass))
...
#define CPUFREQ_SELECTOR_LIBCPUFREQ_GET_CLASS(obj)                    \
  (G_TYPE_INSTANCE_GET_CLASS((obj), CPUFREQ_TYPE_SELECTOR_LIBCPUFREQ, \
                             CPUFreqSelectorLibcpufreqClass))
