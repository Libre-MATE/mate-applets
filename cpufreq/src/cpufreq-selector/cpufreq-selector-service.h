...
#define CPUFREQ_SELECTOR_SERVICE(obj)                               \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), CPUFREQ_TYPE_SELECTOR_SERVICE, \
                              CPUFreqSelectorService))
#define CPUFREQ_SELECTOR_SERVICE_CLASS(klass)                      \
  (G_TYPE_CHECK_CLASS_CAST((klass), CPUFREQ_TYPE_SELECTOR_SERVICE, \
                           CPUFreqSelectorServiceClass))
#define CPUFREQ_IS_SELECTOR_SERVICE(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), CPUFREQ_TYPE_SELECTOR_SERVICE))
#define CPUFREQ_IS_SELECTOR_SERVICE_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), CPUFREQ_TYPE_SELECTOR_SERVICE))
#define CPUFREQ_SELECTOR_SERVICE_GET_CLASS(obj)                    \
  (G_TYPE_INSTANCE_GET_CLASS((obj), CPUFREQ_TYPE_SELECTOR_SERVICE, \
                             CPUFreqSelectorServiceClass))
...
#define CPUFREQ_TYPE_SELECTOR_SERVICE_ERROR \
  (cpufreq_selector_service_error_get_type())
